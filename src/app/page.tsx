...
export default function Home() {
  ...
  return (
    <main className="h-full flex flex-col bg-[#0e1a2f] word-normal">
      <Loader />
      ...
      {skipped && (
        <>
          ...
          <section className="min-h-svh bg-[url('../../public/placeholder256.png')] bg-center bg-repeat-round [background-size:128px] md:[background-size:256px]">
            <div className="container mx-auto flex flex-col gap-6 md:gap-8 items-center justify-center text-right px-8 py-8 ">
              ...
              <div className="flex flex-col gap-2 w-full items-end">
                ...
                >
                  طبعا لقصد لغة الإبداع والفنون، باختصار كل حدث تصنع له هوية
                  خاصة تليق بجمهوره وصانعيه قيمنا أرقى
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2 w-full items-end">
                ...
                >
                  أولاً الابتكار دائما وأبدا البداع شغف الجودة والإتقان في كل
                  مكان الاحترافية طبيعة
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2 w-full items-end">
                ...
                >
                  العمل على إضافة فكرة إبداعية ومبتكرة تقدم الحدث بشكل فريد و
                  مميز
                  <br />
                  العمل على صناعة لحظات أكثر جاذبية تترك أثرا في أذهان الحضور
                  مدى الحياة
                  <br />
