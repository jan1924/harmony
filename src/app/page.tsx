    ...
    <main className="h-full flex flex-col gap-8 bg-[#0e1a2f] word-normal">
      ...
      {skipped && (
        ...
        <div className="flex flex-col gap-2 w-full items-end">
          ...
          >
            نعمل باستمرار على تطوير الذائقة العامة في صناعة الحدث التفاعلي من
            خلال تقديم فعاليات أكثر ابتكاراً وجمالاً وتناغما مع مضمون الحدث
            المقدم للجمهور
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 w-full items-end">
          ...
          >
            طبعا لقصد لغة الإبداع والفنون، باختصار كل حدث تصنع له هوية خاصة تليق
            بجمهوره وصانعيه قيمنا أرقى
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 w-full items-end">
          ...
          >
            ...
            <br />
            العمل على دعم قطاع صناعة الفعاليات والمؤتمرات والمعارض بما يتوافق مع
            رؤية ٢٠٣٠ العمل على إيجاد فرص عمل تليق بشباب وشابات الوطن في هذا
            القطاع
          </p>
        </div>
        <Link href={"/contact"}>
